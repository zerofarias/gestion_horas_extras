-- Cambios de turno entre empleados (por bloque de employee_schedules)
-- Si ya existe shift_swaps con esquema antiguo (requester_id/target_id), ejecutar DROP TABLE shift_swaps; antes o migrar manualmente.

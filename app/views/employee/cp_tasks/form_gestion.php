...
<div class="emp-card emp-form-card">
    <form action="<?php echo URLROOT; ?>/cpTask/store" method="post">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="form_key" value="gestion">
        ...
        <div class="emp-form-group"><label class="emp-label">Hora inicio</label><input type="time" name="start_time" class="emp-input"></div>
